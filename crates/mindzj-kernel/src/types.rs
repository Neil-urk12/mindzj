...
impl VaultPaths {
    pub const CONFIG_DIR: &'static str = ".mindzj";
    pub const SETTINGS_FILE: &'static str = "settings.json";
    pub const WORKSPACE_FILE: &'static str = "workspace.json";
    pub const HOTKEYS_FILE: &'static str = "hotkeys.json";
    pub const PLUGINS_DIR: &'static str = "plugins";
    pub const PLUGINS_CONFIG: &'static str = "plugins.json";
    pub const SNAPSHOTS_DIR: &'static str = "snapshots";
    pub const THEMES_DIR: &'static str = "themes";
    pub const SNIPPETS_DIR: &'static str = "snippets";
    pub const IMAGES_DIR: &'static str = "images";
    pub const FILE_ORDER: &'static str = "file-order.json";
    pub const FOLDER_STATE: &'static str = "folder-state.json";

    /// Full path to the settings file: `.mindzj/settings.json`
    pub fn settings_path() -> String {
        format!("{}/{}", Self::CONFIG_DIR, Self::SETTINGS_FILE)
    }

    /// Full path to the workspace file: `.mindzj/workspace.json`
    pub fn workspace_path() -> String {
        format!("{}/{}", Self::CONFIG_DIR, Self::WORKSPACE_FILE)
    }

    /// Full path to the hotkeys file: `.mindzj/hotkeys.json`
    pub fn hotkeys_path() -> String {
        format!("{}/{}", Self::CONFIG_DIR, Self::HOTKEYS_FILE)
    }

    /// Full path to the plugins config: `.mindzj/plugins.json`
    pub fn plugins_config_path() -> String {
        format!("{}/{}", Self::CONFIG_DIR, Self::PLUGINS_CONFIG)
    }

    /// Full path to the file order file: `.mindzj/file-order.json`
    pub fn file_order_path() -> String {
        format!("{}/{}", Self::CONFIG_DIR, Self::FILE_ORDER)
    }

    /// Full path to the folder state file: `.mindzj/folder-state.json`
    pub fn folder_state_path() -> String {
        format!("{}/{}", Self::CONFIG_DIR, Self::FOLDER_STATE)
    }

    /// Default attachment folder: `.mindzj/images`
    pub fn default_attachment_folder() -> String {
        format!("{}/{}", Self::CONFIG_DIR, Self::IMAGES_DIR)
    }
}
